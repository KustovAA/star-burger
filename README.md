...
Определите переменные окружения `SECRET_KEY`, `ALLOWED_HOSTS`, `YANDEX_API_KEY`. Создать файл `.env` в каталоге `star_burger/` и положите туда такой код:
```sh
SECRET_KEY=django-insecure-0if40nf4nf93n4
ALLOWED_HOSTS=*
YANDEX_API_KEY=<ключ от апи Яндекса>
```
